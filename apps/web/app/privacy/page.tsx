...
export const metadata: Metadata = {
  title: "Privacy Policy — MailOS",
  description: "How MailOS handles your data.",
};
  ...
  return (
    <main className="thread-privacy">
      ...
      <Section title="Overview">
        MailOS (&quot;the app&quot;) is an AI-powered email and calendar management tool. We are
      ...
      <Section title="Data We Access">
        <p>When you connect your Google account, MailOS requests access to:</p>
        <ul>
          <li>
      ...
      <Section title="Data Storage">
        <p>
          MailOS caches a limited snapshot of your recent threads and events in a secure database to
