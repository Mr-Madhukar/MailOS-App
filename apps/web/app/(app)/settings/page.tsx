  ...
  return (
    <div className="thread-app-content-narrow">
      ...
      <section className="thread-set-section">
        <h2>Account</h2>
        <p>Your MailOS identity. Display name is what teammates and the agent use.</p>
        ...
        <div className="thread-set-row" style={{ alignItems: "flex-start", flexDirection: "column", gap: 16 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14, width: "100%" }}>
            ...
            <div style={{ minWidth: 0 }}>
              <div style={{ fontSize: 14, fontWeight: 600 }}>{user.fullName || "MailOS user"}</div>
      ...
      <section className="thread-set-section">
        <h2>Connections</h2>
        <p>MailOS reads Gmail and Calendar through Corsair. Connect once — disconnect anytime.</p>
      ...
      <section className="thread-set-section">
        ...
        <ApprovalToggle
          ...
          description="Emails drafted or sent by MailOS Agent."
