...
const BENTO = [
  ...
  },
  {
    ...
    desc: "MailOS metadata in Postgres — faster reloads and fallback when Gmail is down.",
...
const CAPABILITIES = [
  ...
  { title: "Draft replies", desc: "Compose in MailOS — every send and draft goes through the approval queue first." },
...
const FAQS = [
  {
    q: "What is MailOS?",
    a: "MailOS is a Superhuman-style workflow app for Gmail and Google Calendar, powered by Corsair. You decide which actions are prominent — not Google.",
  },
  {
    q: "How does MailOS use Corsair?",
    a: "Corsair handles Gmail and Calendar OAuth, the search and send APIs, and webhook delivery — MailOS consumes those to read mail, queue actions, and keep its local cache fresh.",
  },
  {
    q: "Is this just a Gmail clone?",
    a: "No. MailOS adds workflow improvements: one-step invites, AI priority, keyboard shortcuts, a human-approval queue, and a local metadata cache.",
  },
  {
    q: "What stack is MailOS built on?",
      ...
      <div className="thread-frame" style={{ padding: "72px 0 0" }}>
        <Reveal style={{ textAlign: "center", padding: "0 32px 48px" }}>
          ...
          <h2 className="thread-h2" style={{ marginTop: 16 }}>
            Plug Gmail &amp; Calendar into MailOS
          </h2>
      ...
      <div className="thread-frame" style={{ padding: "72px 32px" }}>
        <Reveal>
          ...
          <p className="thread-lede" style={{ maxWidth: 480, marginBottom: 36 }}>
            No demo inbox — connect your account and MailOS works on your actual mail and calendar.
          </p>
        </Reveal>
      ...
      <div className="thread-frame" style={{ padding: "72px 32px" }}>
        <div style={{ marginBottom: 36, maxWidth: 520 }}>
          ...
          <p className="thread-lede" style={{ maxWidth: 420 }}>
            A preview of where MailOS is heading: natural language → email + calendar actions over
    ...
    <section id="faq" className="thread-shell thread-section">
      <div className="thread-frame thread-faq-grid">
        <div>
          ...
          <p className="thread-lede">Questions about MailOS &amp; the hackathon build.</p>
        </div>
