        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full h-10 px-3.5 text-sm rounded-lg border transition-all focus:outline-none"
                  style={{
                    background: "rgb(var(--bg-primary))",
                    borderColor: "rgba(var(--border-primary))",
                    color: "rgb(var(--text-primary))",
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-[11px] leading-normal" style={{ color: "rgb(var(--text-tertiary))" }}>
            ...
            <p className="text-[11px]" style={{ color: "rgb(var(--text-tertiary))" }}>
            ...
            <button
              ...
              className="w-full h-10 rounded-lg font-medium text-sm flex items-center justify-center gap-2 transition-all mt-4 hover:opacity-90 active:scale-[0.98]"
              style={{
